...
> 数据：KITTI depth_completion (val_selection_cropped, image_02)（drive `2011_09_26_drive_0023_sync`，30 帧真实驾驶，零下载）。
...
- 闭环：A* **492** 步 / 路径长 **211.84m**；
控制 **491** 条（v_max 0.8 m/s，ω_max 1.5 rad/s）；
避让 **34** 步；动态目标点 **1743**。
